...
const vacanciesList = {
    company       : 'Sber Automotive Technologies – компания, которая строит транспорт, думая о людях. Время – главный ресурс современного человека. Мы научились им управлять благодаря гаджетам. Задача нашей команды – превратить в такой же удобный гаджет автомобиль. Наша команда состоит из лучших специалистов с опытом работы в ведущих компаниях сразу двух рынков: IT и Automotive. Если ты хочешь качественно изменить транспорт и знаешь, что для этого нужно, – ждём тебя в SberAutoTech. Предлагаем сочетание гибкости стартапа и надежности компании. Возможности для самореализации и роста есть для каждого. В нашей команде открыта вакансия сборщика компьютеров для автомобилей.',
    vacancies_list: [{
        id        : 1,
