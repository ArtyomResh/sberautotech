...
const rules = [
    ...
    { imageName: 'buckle-up', text: 'Пристегнуть<br />ремни', alt: 'Изображения знака с человеком пристёгнутым ремнём безопасности' },
    { imageName: 'no-smoking', text: 'Не&#160;курить', alt: 'Изображения знака с перечёркнутой сигаретой' }
];
