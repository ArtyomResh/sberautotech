...
const OpenTesting = () => {
    ...
    return (
        <GridWrapper as="section" className={cn('path-description')}>
            ...
            <Text size={2} as="p">
                Мы&#160;выбрали самые популярные локации, чтобы вписать беспилотные автомобили в&#160;городскую среду и&#160;своими глазами увидеть завтрашний день обычного жителя мегаполиса.
            </Text>
